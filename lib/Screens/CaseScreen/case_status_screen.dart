...
class _CaseStatusScreenState extends State<CaseStatusScreen> {
        ...
        children: [
          ...
          Positioned(
              ...
              child: Container(
                ...
                child:  RoundButton(text: "View Case Status",onPressed: (){
  ...
  Future<void> onGetStatus() async {
    ...
    if(selectedBench == null){
      ...
      CaseInfo res = await ApiService.getCaseDetails(context,selectedctype,selectedBench.id,selectedCaseType.typeName,mCaseNo.text,selectedYear.toString());
      print(res.status);
      if(res != null){
        caseList = res.caseDetails;
        NavHistory.pushPage(context, CaseDetails(caseDetails: caseList,));
      }

    }
    //print(selectedBench.id.toString() + " : " + selectedCaseType.typeName + " : " + selectedYear.toString() + " : " + mCaseNo.text+selectedctype);
