...
class CcaCrCaseList extends StatelessWidget {
  final Copy3_status cs;
  final Function onDownload;

  const CcaCrCaseList({Key key, this.cs, this.onDownload}) : super(key: key);
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Expanded(flex: 4, child: Text("Applcant", style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold),)),
              SizedBox(width: 10,),
